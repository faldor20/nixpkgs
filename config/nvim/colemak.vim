...
"" inSert/Replace/append (T) {{{
    nnoremap h i|onoremap h i
    nnoremap H I|onoremap h i
"    nnoremap t a|
"    nnoremap T A|
"" }}}
 "   nnoremap w o|xnoremap w o|
"    nnoremap W O|xnoremap W O|
"" Change {{{
...
"" }}}
"" Undo/redo {{{
"    nnoremap j u|xnoremap j :<C-U>undo<CR>|
"    nnoremap gj U|xnoremap gj :<C-U>undo<CR>|
"    nnoremap J <C-R>|xnoremap J :<C-U>redo<CR>|
"" }}}
"" Visual mode {{{
